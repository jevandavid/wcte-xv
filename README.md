# WCTE XV 2027 - The Iconic Celebration Tour
## Interest Landing Page

**Project:** Early interest / waitlist capture page for WCTE's 15th Anniversary season (WCTE XV).

**Live Location (planned):** tour.wctedance.com or xv.wctedance.com
...
- **WCTE XV Treatment**: Currently using large text treatment in the Hero ("WCTE XV" + "The Iconic Celebration Tour") instead of the custom logo file.
  - The file `wcte-xv-logo.png` is still in the images folder if you want to bring the image logo back later.
...
**Note:** Old concept files have been cleaned up. Only the official `wcte xv logo.png` remains.
